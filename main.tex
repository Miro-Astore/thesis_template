...
\usepackage{epigraph}
\usepackage[backref=pages,backend=bibtex,style=chem-acs,natbib=true,doi=true,isbn=false,url=true,arxiv=false]{biblatex}
...
%}
\input{./07-Foreword}
\input{./08-Introduction}
\input{./09-Methods}
\input{./10-CFTR-Review}
\input{./11-I37R.tex}
\input{./12-R352Q.tex}
\input{./13-S945L.tex}
\input{./14-Open-CFTR.tex}
\input{./15-Conclusions.tex}
\input{./16-Appendix.tex}
