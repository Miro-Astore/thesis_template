...
%\includeonly{./08-Introduction}
%\includeonly{./13-S945L}
%\includeonly{./14-Open-CFTR}
\includeonly{./15-Perspective,./16-Conclusion}
...
\include{./09-Methods}
\include{./10-CFTR-Review}
\include{./11-I37R}
\include{./12-R352Q}
\include{./13-S945L}
\include{./14-Open-CFTR}
\include{./15-Perspective}
\include{./16-Conclusion}
\include{./17-Afterword}
\include{./18-Appendix}
