...
\section{Ion Channels: Natures laboratories to Learn Biophysics}
...
\subsubsection{Ion Channels and Their Role in Developing Biophysics}
...
The $\alpha$ and $beta$ parameters are the proportion of the sodium and potassium channel populations which are activated respecitively.

This is an example of the use of theory to discovery features at the smaller level.  
