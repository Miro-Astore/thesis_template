...
This thesis seeks to apply a molecular philosophy on biophysics to demonstrate its ability to elucidate pressing problems in biology and medicine. In particular, we will look at how knowledge of the molecular details in the function of a protein ion channel has for important cellular functions.
...
Chapter \ref{chap:methods} describes in some detail the chemical and numerical simulation techniques we used to study the CFTR protein system.  Chapters \ref{chap:i37r}, \ref{chap:r352q}, \ref{chap:s945l} and \ref{chap:opening} demonstrate how a diverse application of these techniques can be used to discover unique modes of misfunction introduced by a mutation and in combination with \textit {in vitro} cellular techniques, prove that these mutations can be rescued by existing drug regimens.  Finally, chapter \ref{chap:conclusion} argues for a physical model for the mechanism of action for cystic fibrosis drugs. This model has broad implications for the treatment of patients with rare mutations which cause cystic fibrosis.


\section{What is Physics?}
Personally, I have always described physics along the lines of "the study of the movement of energy through a system" or when I was in high school "the study of how things move". Although adequate for a layman, such descriptions obscure the philosophy within physics which make it such a powerful tool. Physical theories rely on the conceptualisation of some causal unit in a system, they then use mathematics to scale up the behaviour of that unit to make predictions about measurable phenomena. This is what makes physics feel like the most "fundamental" of the sciences

These causal units take a few forms. Examples might be.

The gas of hard spheres, which we use to derive kinetic theory of gasses.  

The Electric and magnetic vector fields, which interact to produce Maxwell's laws of electromagnetism.

The Reimannian manifolds along which masses travel in Einstein's theories of relativity.

The probability waves described in Schr\"oedinger's wave equation, which evolve to describe quantum mechanics. 

As biophysicists we would wish to the most basic causaul units of biological phenomenon. The quest for this causal unit has an interesting origin. Erwin Schr\"oedinger wrote an essay titled "What is Life?" This remarkable work, written in  1944 before the discovery of DNA's structure or the maturation of information theory speculates from first principals in thermodynamics and quantum mechanics, the nature of life at the atomic level. The most remarkble thing about this essay is how much the author gets right. The observation that since organisms exist at temperatures in the hundreds of Kelvin the phyical encoding information in their genome must be chemical in nature, as energy barriers lower than that of chemical bonds would be oblated by at physiological temperatures. Schr\"oedinger posits the existence of what he  calls an "aperiodic crystal". He was right, this crystal just happened to be one dimensional. This allegory is an example of how physcial principals can in fact be used to make testable, far reaching predictions about fundamental biology. The details may simply be more difficult since it is harder to capture the heterogeneous details inside cells.

 Naturally, when studying the molecular basis of life we start with atoms, hence our focus on the latter concepts in chapter \ref{chap:methods}. 
