...
\begin{figure}
	\begin{center}
		\includegraphics[width=0.8\textwidth]{figures/gramicidin/gramicidin.png}
	\end{center}
	\captionsetup{singlelinecheck = false, justification=raggedright}
	\caption[Gramicidin A in a lipid bilayer] {\textbf{Gramicidin A in a lipid bilayer}}{Gramicidin A forms a small ion channel which selectively allows the diffusion of potassium ions. This makes it an excellent test system for early molecular dynamics simulations \cite{allen2004}.}
	\label{action_potential_graphic}
\end{figure}
