...
\nomenclature{${\small ASCT}$}     {Alanine-Serine-Cysteine transporters}
...
\nomenclature{${\small EAAT}$}     {Excitatory Amino Acid Transporters}
...
\nomenclature{${\small SBC}$}      {Spherical Boundary Condition}
