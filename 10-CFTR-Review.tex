...
Although useful, in reality this paradigm struggles to reflect the fact that a mutation can belong to multiple categories to differing degrees, due to different modes of pathogenesis. Further, in our molecular simulations we will see that in CFTR modulators are capable of many different mutations with unique modes of pathogenesis. We will break down this paradigm into more molecular detail in chapter \ref{chap:conclusions}
