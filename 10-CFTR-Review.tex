...
Cystic Fibrosis (CF) is the most common fatal genetic condition in Caucasian populations. 162 000 people are estimated to be afflicted globally, with a significant proportion living undiagnosed \cite{guo2022}. Even with decades of research there is no known cure for CF. With the average life expectancy of patients falling below 50 even in countries with developed health care systems such as the USA and Australia \cite{mcbennett2022}. Management of disease symptoms also significant financial and emotional costs to patients' families \cite{vangool2013}. From a cellular perspective the symptoms of the disease are due to the inability of cells to regulate their salt content. 
...
CF is inhereted through mendelean genetics. Two defective copies of the CFTR gene. 1 in 25 people of Northern European descent are a carrier for a deffective copy of CFTR and carriers are at increased risk for many health problems \cite{ioannou2014, miller2020}.
