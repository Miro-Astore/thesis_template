...
In post processing, the motions of the transmembrane helices were analysed using Principal Component Analysis. This revealed large motions in TMs1 and 6 in directions which dilated the extracellular pore (Figure \ref{PCA_motions}).  
...
Since the more atoms included in our colelctive variables the slower our calculations would run . 

\subsection{OPES-Metadynamics Finds a Stable Conformation with an Open Pore }
...
This completely removed the aberant constriction from the cryo-EM structure of CFTR \ref{summary_FES}D.
