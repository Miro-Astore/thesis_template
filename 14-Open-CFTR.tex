...
\subsection{The Open State Can be Used to Study Disease Causing Mutations in the Outer Wore, such as R334W}
...
There are several disease causing CFTR mutations which occur at the extracellular mouth of the protein (E116K, R334[WQL],R117[HCP], I336K, S341P)\cite{cftr2}. Note how these are all clustered around TM1 and TM6. This is good evidence to suggest that this is the permeation pathway for chloride in hCFTR, as was found in zCFTR \cite{farkas2020}. A molecular understanding of these mutations can aid in the design of new therapeutics and so we used our dilated structure to study one of the most severe mutations at the extracellular mouth, R334W. Whole cell measuremnts have revealed that this mutation exhibits 1.3\% of the current levels of WT-CFTR \cite{}. This corresponds well to the deleterious barrier height we discovered in our 2.5 kcal/mol we discovered in our R334W-CFTR umbrella sampling calculations. This extra barrier height corresponds to 4$k_BT$ in natural units, representing an $e^4=54$ suppression of current in the mutant, according Einstein-Nernst relation \cite{}.
