...
The first two principal components were chosen for further analysis as these two together represented 38\% of the kinetic variance in the data.
...
Mutations at R334 also exhibit a gating defect, with infrequent transitions to the fully open state \cite{fuller2005, cui2013a}. It is likely that an invovled path Metadynamics or string method with swarms of trajectories approach might reveal the pathogenic gating defect present in this mutation. Construction of such a protocol could be used to investigate outher outer viestibutle gating class defects such as R117.
