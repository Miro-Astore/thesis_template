...
\begin{tabular} { |c|c|c| } 
	\hline
	System & Fastest Degree of Freedom & Correlation time of Motion \\ 
	Atoms  & Translation & 10 fs  \\ 
	Rigid Molecules & Rigid Body Rotation & 5 fs \\  
	Flexible Molecules with Rigid Bonds & Bond Torsions & 2 fs  \\ 
	Completely Flexible Molecule & Light Atom Vibrations & 1 fs  \\ 
	\hline
\end{tabular}

As you can see in table \ref{atomic_motions_speed} the fastest motion in molecular systems is dicatted by the translation of hydrogen atoms. Virtual site topologies aim to remove the requirement for calculating these motions every time step by instead interpolating the positions of hydrogen atoms from the positions of surrounding heavy atoms. 
