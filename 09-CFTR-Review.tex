...
GLPG1837 has not been approved in a clinical setting. \textit {in vitro} experiments suggest that it is more efficatious even though it has lower affinity for CFTR binding (CITATION NEEDED).  
